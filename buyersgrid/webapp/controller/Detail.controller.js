sap.ui.define([
	...
	return BaseController.extend("cf.buyersgrid.controller.Detail", {
		...
		onAfterRendering: function (oEvent) {
			// this.selectedCat = document.getElementById('container-buyersgrid---App--prodCat-labelText').innerHTML;
		...
		bindData: function (selectedData) {
			...
			selectedData.TM1_PRICE_CONCAT__C = "$" + (parseFloat(selectedData.TM1_ROLL_PRICE__C)).toFixed(2) + " / $" + (parseFloat(selectedData.TM1_CUT_PRICE__C)).toFixed(
				2);
			selectedData.TM_2_PRICE_CONCAT__C = "$" + (parseFloat(selectedData.TM2_ROLL_PRICE__C)).toFixed(2) + " / $" + (parseFloat(selectedData.TM2_CUT_PRICE__C)).toFixed(
				2);
			selectedData.TM3_PRICE_CONCAT__C = "$" + (parseFloat(selectedData.TM3_ROLL_PRICE__C)).toFixed(2) + " / $" + (parseFloat(selectedData.TM3_CUT_PRICE__C)).toFixed(
				2);
			...
			/*selectedData.TM1_ROLL_PRICE__C !== null && selectedData.TM1_CUT_PRICE__C !== null ? selectedData.TM1_PRICE_CONCAT__C = "$" + (selectedData.TM1_ROLL_PRICE__C).toFixed(2) + " / $" + (selectedData.TM1_CUT_PRICE__C).toFixed(2) : selectedData.TM1_PRICE_CONCAT__C = selectedData.TM1_ROLL_PRICE__C + " / " + selectedData.TM1_CUT_PRICE__C;
			selectedData.TM2_ROLL_PRICE__C !== null && selectedData.TM2_CUT_PRICE__C !== null ? selectedData.TM_2_PRICE_CONCAT__C = "$" + (selectedData.TM2_ROLL_PRICE__C).toFixed(2) + " / $" + (selectedData.TM2_CUT_PRICE__C).toFixed(2) : selectedData.TM_2_PRICE_CONCAT__C = selectedData.TM2_ROLL_PRICE__C + " / " + selectedData.TM2_CUT_PRICE__C;
			selectedData.TM3_ROLL_PRICE__C !== null && selectedData.TM3_CUT_PRICE__C !== null ? selectedData.TM3_PRICE_CONCAT__C = "$" + (selectedData.TM3_ROLL_PRICE__C).toFixed(2) + " / $" + (selectedData.TM3_CUT_PRICE__C).toFixed(2) : selectedData.TM3_PRICE_CONCAT__C = selectedData.TM3_ROLL_PRICE__C+ " / " + selectedData.TM3_CUT_PRICE__C;
			selectedData.DM_ROLL_PRICE__C !== null && selectedData.DM_CUT_PRICE__C !== null ? selectedData.DM_PRICE_CONCAT__C = "$" + (parseFloat(selectedData.DM_ROLL_PRICE__C)).toFixed(2) + " / $" + (parseFloat(selectedData.DM_CUT_PRICE__C)).toFixed(2) : selectedData.DM_PRICE_CONCAT__C = selectedData.DM_ROLL_PRICE__C + " / " + selectedData.DM_CUT_PRICE__C;
			selectedData.RVP_ROLL_PRICE__C !== null && selectedData.RVP_CUT_PRICE__C !== null ? selectedData.RVP_PRICE_CONCAT__C = "$" + (parseFloat(selectedData.RVP_ROLL_PRICE__C)).toFixed(2) + " / $" + (parseFloat(selectedData.RVP_CUT_PRICE__C)).toFixed(2) : selectedData.RVP_PRICE_CONCAT__C = selectedData.RVP_ROLL_PRICE__C + " / " + selectedData.RVP_CUT_PRICE__C;
*/
